...
public class TablePdoQueryEidDaoTest {
	...
	public void testPdoBuildQuery() throws Exception {
		...
		String filename = testFileDir + "/pdo_eidsinglequote.xml";
		...
		PdoQueryEidDao pdoQueryEidDao = new PdoQueryEidDao(dataSourceLookup,
				dataSource);
		...
		edu.harvard.i2b2.crc.datavo.pdo.EidSet eidSet = pdoQueryEidDao
				.getEidByFact(panelSqlList, sqlParamCountList,
						inputOptionListHandler, true, true, true);
		System.out.println(eidSet.getEid().size());
