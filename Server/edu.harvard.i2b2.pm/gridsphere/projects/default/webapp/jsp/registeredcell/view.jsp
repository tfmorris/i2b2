  ...
  if (errors == false) {
	ShowHide2(szDivID, 0)
	 // var elSel = document.getElementById('selectX');
	    var elSel = document.forms[0].ui_lb_registeredcellparamslist_;
...
<tr><td valign="top">
<div id="col">
	<img src="/default/html/images/hive-small.gif"><B>Manage Cells</b>
	<div class="line">&nbsp;</div>
...
<td valign="top">
 <div id="param_new" name="parm_new">
		<img src="/default/html/images/cell-small.gif"><B>Add New Cell</B>
		<div class="line">&nbsp;</div>
		...
		<td id="lefturl"><ui:text value="Base URL:"/></td>
		...
		<tr>
		<td> <ui:text value="Web Service Method:"/></td>
		        <td>
		...
		<table>
			...
			<td>
			<%-- --%>
	        <ui:listbox id="selectX" beanId="registeredcellparamslist"  size="5" >
		</ui:listbox>
<%--<select id="selectX"  size="5" multiple="multiple" class="portlet-form-field" size="5" name="ui_lb_registeredcellparamslist_" style="color: black;">
			</select> 
			--%>
			<br clear="all"/>
			<input type=button value="New Variable" onclick="ShowHide2('param_new3', 1)">
