...
overl3 = document.forms[0].ui_lb_variabledatalist_;
...
<tr><td valign="top">
<div id="col">
	<img src="/default/html/images/hive-small.gif"><B>Manage Group Variables</b>
	<div class="line">&nbsp;</div>
	<ui:text value="Register new group variables or delete existing ones:"/>
	<br />


	<div id="dyn_table" name="dyn_table" class="channel_fields">
	        <ui:listbox id="mike" beanId="variabledatalist"  size="5" >
		</ui:listbox>

		<br clear="all"/>
		<input id="delete" class="portlet-form-button" type="submit" value="Remove Selected" name="gs_action=deleteVariableData"/> 
		<br clear="all"/>
		<div class="line">&nbsp;</div>

		<input type=button name="add" value="Add New Group Variable -->" onclick="disableDiv(); ShowHide2('param_new', 1)">
	</div>
</div>
</td>
<td valign="top">
 <div id="param_new" name="parm_new">
		<img src="/default/html/images/cell-small.gif"><B>Add Group Variable</B>
		<div class="line">&nbsp;</div>
		<table>
		...
		<div class="line">&nbsp;</div>
	 		<ui:actionsubmit  action="addVariableData" value="Save"/> 
