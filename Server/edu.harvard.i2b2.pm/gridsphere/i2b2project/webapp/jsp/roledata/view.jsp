...
<tr><td valign="top">
<div id="col">
	<img src="/jsrtutorial/html/images/hive-small.gif"><B>Manage Group Role</b>
	<div class="line">&nbsp;</div>
	...
	<div id="dyn_table" name="dyn_table" class="channel_fields">
		...
		<input type=button name="add" value="Add New Project Role -->" onclick="disableDiv(); ShowHide2('param_new', 1)">
	</div>
</div>
</td>
<td valign="top">
 <div id="param_new" name="parm_new">
		<img src="/jsrtutorial/html/images/cell-small.gif"><B>Add Group Role</B>
		<div class="line">&nbsp;</div>
