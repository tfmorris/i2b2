...
public class MessageFactory {
    ...
    public static OMElement createResponseOMElementFromString(String xmlString)
        ...
        try {
            ...
            OMNamespace ns = factory.createOMNamespace("http://mgh.harvard.edu/i2b2",
                    "i2b2");
            returnElement = factory.createOMElement("getConfigureTypeResponse",
                    ns);
     ...
     */
    public static BodyType createBodyType(ConfigureType uType) {
        ...
        */
        /* OLD
    	ResponseType patientData = new ResponseType();
        patientData.setConfigure(uType); //.getObservationFactSet().add(obsSet);
        edu.harvard.i2b2.pm.datavo.pm.ObjectFactory of = new edu.harvard.i2b2.pm.datavo.pm.ObjectFactory();
        BodyType bodyType = new BodyType();
        bodyType.getAny().add(of.createResponse(patientData));
		*/
        edu.harvard.i2b2.pm.datavo.pm.ObjectFactory of = new edu.harvard.i2b2.pm.datavo.pm.ObjectFactory();
        BodyType bodyType = new BodyType();
        bodyType.getAny().add(of.createConfigure(uType));
