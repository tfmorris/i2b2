...
public class GetSchemesHandlerTest {
...
//"</message_body> " +
	...
	public static void main(String args[]){
		...
		try {
			GetSchemesDataMessage schemesDataMsg = new GetSchemesDataMessage(requestVdo);	

			GetReturnType type = schemesDataMsg.getReturnType();
			
			GetSchemesHandler handler = new GetSchemesHandler(schemesDataMsg);
