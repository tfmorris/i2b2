...
public class GetCodeInfoDataMessage extends RequestDataMessage{

	private static Log log = LogFactory.getLog(GetCodeInfoDataMessage.class);

	public GetCodeInfoDataMessage(String requestVdo) throws I2B2Exception {
		super(requestVdo);
	}
