...
public class GetSchemesDataMessage extends RequestDataMessage{

	private static Log log = LogFactory.getLog(GetSchemesDataMessage.class);
    
	public GetSchemesDataMessage(String requestVdo) throws I2B2Exception {
		super(requestVdo);
	}
