...
public class TablePdoQueryProviderDaoTest {
	...
	public void testPdoBuildQuery() throws Exception {
		...
		String filename = testFileDir + "/pdo_providersinglequote.xml";
		...
		TablePdoQueryProviderDao tablePdoQueryProviderDao = new TablePdoQueryProviderDao(
		...
		ObserverSet observerSet = tablePdoQueryProviderDao.getProviderByFact(
				panelSqlList, sqlParamCountList, inputOptionListHandler, true,
				true, true);
		System.out.println(observerSet.getObserver().size());
