...
public class TablePdoQueryConceptDaoTest {
	...
	public void testPdoBuildQuery() throws Exception {
		...
		String filename = testFileDir + "/pdo_conceptcdsinglequote.xml";
		...
		TablePdoQueryConceptDao tablePdoQueryConceptDao = new TablePdoQueryConceptDao(
		...
		ConceptSet conceptSet = tablePdoQueryConceptDao.getConceptByFact(
				panelSqlList, sqlParamCountList, inputOptionListHandler, true,
				true, true);
		System.out.println(conceptSet.getConcept().size());
