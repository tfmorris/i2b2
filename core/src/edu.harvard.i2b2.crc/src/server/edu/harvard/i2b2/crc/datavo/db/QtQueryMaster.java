...
public class QtQueryMaster  implements java.io.Serializable {
	...
	/** minimal constructor */
    public QtQueryMaster(String queryMasterId, String name, String userId, String groupId, Date createDate) {
    ...
    /** full constructor */
    public QtQueryMaster(String queryMasterId, String name, String userId, String groupId, Date createDate, Date deleteDate, String requestXml, Set<QtQueryInstance> qtQueryInstances) {
       this.queryMasterId = queryMasterId;
       this.name = name;
       this.userId = userId;
       this.groupId = groupId;
