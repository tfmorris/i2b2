...
public class QtQueryResultInstance  implements java.io.Serializable {
    ...
    // Fields    
     ...
     private QtQueryResultType qtQueryResultType;
     private QtQueryInstance qtQueryInstance;
	...
	/** minimal constructor */
    public QtQueryResultInstance(String resultInstanceId, QtQueryStatusType qtQueryStatusType, QtQueryResultType qtQueryResultType, Date startDate) {
    ...
    /** full constructor */
    public QtQueryResultInstance(String resultInstanceId, QtQueryStatusType qtQueryStatusType, QtQueryResultType qtQueryResultType, QtQueryInstance qtQueryInstance, Integer setSize, Date startDate, Date endDate, Set<QtXmlResult> qtXmlResults, Set<QtPatientSetCollection> qtPatientSetCollections, Set<QtPatientEncCollection> qtPatientEncCollections) {
       this.resultInstanceId = resultInstanceId;
       this.qtQueryStatusType = qtQueryStatusType;
       this.qtQueryResultType = qtQueryResultType;
