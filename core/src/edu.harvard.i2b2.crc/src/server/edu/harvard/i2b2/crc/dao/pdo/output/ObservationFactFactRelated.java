 ...
 * for ObservationFact based on pdo's  OutputOptionType
 * $Id: ObservationFactFactRelated.java,v 1.4 2007/08/31 14:43:33 rk903 Exp $
 * @author rkuttan
 */
public class ObservationFactFactRelated extends FactRelated {
    ...
    public String getSelectClause() {
        ...
        if (isSelected()) {
            ...
            // Adding modifier_cd slow down the query  , obs.modifier_cd obs_modifier_cd " 
            if (isSelectDetail()) {
