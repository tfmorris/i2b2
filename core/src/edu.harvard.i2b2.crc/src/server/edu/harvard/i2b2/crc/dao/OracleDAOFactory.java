...
public class OracleDAOFactory implements IDAOFactory {
	...
	public OracleDAOFactory(DataSourceLookup dataSourceLookup) throws I2B2DAOException {
	...
	public SetFinderDAOFactory getSetFinderDAOFactory() {
		return new OracleSetFinderDAOFactory();
	}
	
	
	public PatientDataDAOFactory getPatientDataDAOFactory() {
		return new OraclePatientDataDAOFactory();
	}
