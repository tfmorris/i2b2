 ...
 * $Id: CRCJAXBUtil.java,v 1.6 2007/09/11 20:05:40 rk903 Exp $
 * @author rkuttan
 */
public class CRCJAXBUtil {
	...
	public static edu.harvard.i2b2.common.util.jaxb.JAXBUtil getQueryDefJAXBUtil()  {
        if (queryDefjaxbUtil == null) {
				queryDefjaxbUtil = new edu.harvard.i2b2.common.util.jaxb.JAXBUtil(edu.harvard.i2b2.crc.datavo.setfinder.query.QueryDefinitionType.class);
        }
