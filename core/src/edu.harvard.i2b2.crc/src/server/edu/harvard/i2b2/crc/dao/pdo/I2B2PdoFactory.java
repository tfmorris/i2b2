 ...
 * 
 * $Id: I2B2PdoFactory.java,v 1.10 2007/10/01 19:22:17 rk903 Exp $
 * @author rkuttan
 */
public class I2B2PdoFactory {
    ...
    public class ObservationFactBuilder {
        ...
        public ObservationType buildObservationSet(ResultSet rowSet)
            ...
            observationFactType.setPatientId(rowSet.getString("obs_patient_num"));
            ...
            modifierCd.setValue(rowSet.getString(
            "obs_modifier_cd"));
            ...
            observerCd.setValue(((rowSet.getString(
                    "obs_provider_id") != null)
                ? rowSet.getString("obs_provider_id") : ""));
            ...
            if (obsFactDetailFlag) {
                ...
                observationFactType.setTvalChar((rowSet.getString(
                        "obs_tval_char") != null)
                ...
                observationFactType.setQuantityNum(rowSet.getBigDecimal("obs_quantity_num"));
                ...
                locationCd.setValue(rowSet.getString(
                "obs_location_cd"));
                observationFactType.setLocationCd(locationCd);
                //Double confidenceNum = rowSet.getDouble("obs_confidence_num");
            }
            ...
            if (obsFactStatusFlag) {
                ...
                observationFactType.setSourcesystemCd(rowSet.getString(
                        "obs_sourcesystem_cd"));
            }
    ...
    public class PatientBuilder {
        ...
        public PatientType buildPatientSet(ResultSet rowSet)
            ...
            patientDimensionType.setPatientId(rowSet.getString(
                    "patient_patient_num"));
            ...
            if (patientDetailFlag) {
    			String vitalStatusCd = rowSet.getString("patient_vital_status_cd");
            ...
            if (patientBlobFlag) {
                ...
                if (patientClob != null) {
                    ...
                    patientBlobType.getContent()
                                   .add(JDBCUtil.getClobString(patientClob));
        ...
        public ObserverType buildObserverSet(ResultSet rowSet)
            ...
            if (providerBlobFlag) {
                ...
                if (providerClob != null) {
                    ...
                    providerBlobType.getContent()
                                    .add(JDBCUtil.getClobString(providerClob));
    ...
    public class ConceptBuilder {
        ...
        public ConceptType buildConceptSet(ResultSet rowSet)
            ...
            if (conceptBlobFlag) {
                ...
                conceptBlobType.getContent()
                               .add(rowSet.getBlob("concept_concept_blob"));
    ...
    public class EventBuilder {
         ...
         * @throws IOException
         */
        public EventType buildEventSet(ResultSet rowSet)
            throws SQLException, IOException {
            ...
            eventId.setValue(rowSet.getString(
            "visit_encounter_num"));
