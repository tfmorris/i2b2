 ...
 * for concept dimenstion based on pdo's  OutputOptionType
 * $Id: ConceptFactRelated.java,v 1.3 2007/08/31 14:43:33 rk903 Exp $
 * @author rkuttan
 */
public class ConceptFactRelated extends FactRelated {
    ...
    public String getSelectClause() {
        ...
        if (isSelected()) {
            ...
            if (isSelectDetail()) {
                selectClause += " ,concept.concept_path concept_concept_path, concept.name_char concept_name_char, concept.table_name concept_table_name";
            }
            ...
            if (isSelectStatus()) {
                selectClause += " , concept.update_date concept_update_date, concept.download_date concept_download_date, concept.import_date concept_import_date, concept.sourcesystem_cd concept_sourcesystem_cd  ";
            }
        }
