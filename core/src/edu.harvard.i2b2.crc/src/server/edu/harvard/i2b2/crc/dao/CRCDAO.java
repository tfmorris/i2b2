...
/**
 * DAO abstract class to provide common dao functions
 * $Id: CRCDAO.java,v 1.6 2007/08/30 21:00:00 rk903 Exp $
 * @author rkuttan
 * @see Connection
 * @see Session
 */
public abstract class CRCDAO {
    ...
    /**
     * Helper function to construct {@link OutputOptionType} 
     * from given boolean flags
     * @param detailFlag
     * @param blobFlag
     * @param statusFlag
