 ...
 *
 * <p>This class implements methods related to 
 * webservice operation. 
 * <li>For example 
 * http://localhost:8080/axis2/services/crc/serfinderrequest 
 * http://localhost:8080/axis2/services/crc/pdorequest 
 *
 * $Id: QueryService.java,v 1.12 2007/08/30 21:00:00 rk903 Exp $
 * @author rkuttan
...
public class QueryService {
    ...
    public OMElement request(OMElement omElement) {
        Assert.notNull(omElement, "Setfinder request OMElement must not be null");
