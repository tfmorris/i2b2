...
CREATE TABLE QT_QUERY_MASTER (
     ...
     , DELETE_DATE DATE 
     , REQUEST_XML CLOB
     //, CONSTRAINT QT_FK_QM_USER FOREIGN KEY (USER_ID)
     //             REFERENCES USER (USER_ID)
     //, CONSTRAINT QT_UNIQ_UGN UNIQUE (GROUP_ID,NAME)
)
/
...
//TABLE REMOVED
//CREATE TABLE QT_QUERY_RESULT (
//       RESULT_ID NUMBER(5,0) PRIMARY KEY
...
//CREATE TABLE QT_QUERY_STATUS (
//       STATUS_ID NUMBER(5,0) PRIMARY KEY
//     , STATUS_TYPE_ID NUMBER(3,0) NOT NULL
//     , DATE_STARTED DATE NOT NULL
//     , DATE_FINISHED DATE
//     , CONSTRAINT QT_FK_QS_STID FOREIGN KEY (STATUS_TYPE_ID)
...
//CREATE TABLE QT_PATIENT_SET_RESULT (
//       PATIENT_SET_RESULT_ID NUMBER(5,0) PRIMARY KEY
//     , RESULT_INSTANCE_ID NUMBER(5,0)
//     , SET_SIZE NUMBER(5,0)
//     , CONSTRAINT QT_FK_PIDRES_RIID FOREIGN KEY (RESULT_INSTANCE_ID )
...
//CREATE TABLE QT_PATIENT_ENC_SET_RESULT (
//       PATIENT_ENC_SET_RESULT_ID NUMBER(5,0) PRIMARY KEY
//     , RESULT_INSTANCE_ID NUMBER(5,0) 
//     , SET_SIZE NUMBER(5,0)
///     , CONSTRAINT QT_FK_PER_RIID FOREIGN KEY (RESULT_INSTANCE_ID )
//                  REFERENCES QT_QUERY_RESULT_INSTANCE (RESULT_INSTANCE_ID)
//)
///
...
//create sequence QT_SQ_QPR_PRID start with 1
/
...
//create sequence QT_SQ_QPER_PERID start with 1
///
