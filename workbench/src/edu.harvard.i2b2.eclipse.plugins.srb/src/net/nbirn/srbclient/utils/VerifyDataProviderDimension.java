...
public  class VerifyDataProviderDimension implements VerifyData {
	...
	public void init()
	{
		...
		headerName.add("PROV"); headerName.add("PATH"); headerName.add("NAME"); 
		headerName.add("BLOB"); headerName.add("UPDA");	headerName.add("DOWN"); 
	...
	public void validateData(TableItem abc, boolean editable,  boolean hasStatus, Vector<String> csv, String[] headers)
	{
		...
		if (hasStatus) {
			...
			//PK can not be null
			loc = headerLocation[headerName.indexOf("PATH") ];
