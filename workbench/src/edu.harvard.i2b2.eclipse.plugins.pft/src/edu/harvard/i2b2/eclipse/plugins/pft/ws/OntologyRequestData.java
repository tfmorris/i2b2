...
import edu.harvard.i2b2.pftclient.datavo.i2b2message.SecurityType;
...
//	abstract public String doBuildXML();
	...
	public String getXMLString(RequestMessageType reqMessageType) throws JAXBUtilException{ 
		...
		try {
			...
			PFTJAXBUtil.getJAXBUtil().marshaller(of.createRequest(reqMessageType), strWriter);
