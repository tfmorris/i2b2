...
public class QueryMasterData extends QueryData {
	...
	public String writeRenameQueryXML(String newName) {
		...
		headerType.setRequestType(PsmRequestTypeType.CRC_QRY_RENAME_QUERY_MASTER);
		
		masterRenameRequestType.setQueryMasterId(new Integer(id()));
	...
	public String writeDeleteQueryXML() {
		...
		masterDeleteRequestType.setQueryMasterId(new Integer(id()));
		...
		//System.out.println("Generated delete XML request: " + strWriter.toString());
		return strWriter.toString();
	}
	...
	public String writeContentQueryXML() {
		...
		userType.setValue(userId());
		headerType.setUser(userType);
		headerType.setRequestType(PsmRequestTypeType.CRC_QRY_GET_QUERY_INSTANCE_LIST_FROM_QUERY_MASTER_ID);
		
		masterQueryType.setQueryMasterId(new Integer(id()));
