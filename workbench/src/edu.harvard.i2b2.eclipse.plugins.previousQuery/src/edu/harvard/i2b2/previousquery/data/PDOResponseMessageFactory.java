...
import edu.harvard.i2b2.previousquery.ui.QueryListNamesClient;

public class PDOResponseMessageFactory {
	public StatusType getStatusFromResponseXML(String responseXML) throws Exception {
	...
	public List<ObservationSet> getFactSetsFromResponseXML(String responseXML) throws Exception {
        ...
        PatientDataResponseType responseType = (PatientDataResponseType) new JAXBUnWrapHelper().getObjectByClass(bodyType.getAny(),PatientDataResponseType.class);
	...
	public static void main(String args[]) throws Exception { 
		...
		String xmlrequest = pdoFactory.requestXmlMessage("zzp___050206101533684227.xml", new Integer(0), new Integer(25), false);
		System.out.println("Request: "+xmlrequest);
		String response = QueryListNamesClient.sendPDORequestSOAP(xmlrequest, true);
		//System.out.println("Response: "+response);	
		PatientSet patientSet = new PDOResponseMessageFactory().getPatientSetFromResponseXML(response);
		System.out.println("Patient set size: "+patientSet.getPatient().size());
	}
}
