...
public class PatientData extends QueryData {
	...
	public void patientID(String str) {patientID = new String(str);}
	public String patientID() {return patientID;}
	
	private String patientSetID;
	public void patientSetID(String str) {patientSetID = new String(str);}
	public String patientSetID() {return patientSetID;}
	
	private String lastName;
	public void lastName(String str) {lastName = new String(str);}
	public String lastName() {return lastName;}
	
	private String firstName;
	public void firstName(String str) {firstName = new String(str);}
