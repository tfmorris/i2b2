...
public class BannerC extends Composite {
	...
	protected void createContents(Composite parent) {
		...
		//create menu for dropdown, create menu items, and add listeners for dropdown tool item
		...
		/*statusLabel.addPaintListener(new PaintListener() {
			public void paintControl(PaintEvent e) {
				...
				// e.gc.drawOval(0,0,12,12);
				e.gc.fillOval(50, 2, 16, 16);
				// e.gc.drawString("Status:", 5,5);
			}
		});*/
		// add listener 
