...
public class WaitPanel extends javax.swing.JPanel implements Runnable {
    ...
    public void init(int width, int height) {
        ...
        minuteLabel.setFont(thisFont);
       
        seperateLabel = new javax.swing.JLabel();
        add(seperateLabel);
        seperateLabel.setText(":");
        seperateLabel.setBounds(width+100, height+120, 10, 40);
        seperateLabel.setFont(thisFont);
        
        secondLabel = new javax.swing.JLabel();
        add(secondLabel);
        secondLabel.setBounds(width+112, height+120, 25, 40);
        secondLabel.setText("00");
        secondLabel.setFont(thisFont);
       */ 
        ...
        while (true) {
          ...
          if(elapsedTime == 60) {
        	  ...
        	  if(elapsedMinute < 10) {
        		  ...
        		  //minuteLabel.setText("0"+new Integer(elapsedMinute).toString());
        	  }
        	  else {
        		  min = new Integer(elapsedMinute).toString();
        		  //minuteLabel.setText(new Integer(elapsedMinute).toString());
        	  }
          }
...
class GIFPanel extends javax.swing.JPanel implements Runnable {
   ...
   public void paintComponent(Graphics comp) {
     ...
     System.out.println("In paint drawtime: "+drawtime);
     System.out.println("In paint elapsed time: "+elapsedTime);
     ...
     if (img != null && candraw) {
    	 //elapsedTime = cur; 
       comp2D.drawImage(img, (int) xPosition, (int) yPosition, this);
       drawtime++;
       candraw = false;
     }
   }
