...
public class AdditionalItemsDialog extends Dialog {
	  ...
	  private void createContents(final Shell shell) {
	    ...
	    final org.eclipse.swt.widgets.List addList = new org.eclipse.swt.widgets.List(shell, SWT.MULTI|SWT.BORDER|SWT.V_SCROLL);
	    ...
	    if ((input!=null)||(input.length>0))
	    {
	    	...
	    	{
	    		if ((input[i]!=null)&&(input[i].equals("Encounter Range Line")))
	    			addList.remove("Encounter Range Line");
	    		else if ((input[i]!=null)&&(input[i].equals("Vital Status Line")))
