 ...
 * 
 * 
 * @see edu.harvard.i2b2.explorer.KTableModel
 * @see de.kupzog.ktable.KTableCellRenderer
 * @see edu.harvard.i2b2.explorer.KTableCellEditor
 * @see edu.harvard.i2b2.explorer.KTableCellSelectionListener
 * 
...
public class KTable extends Canvas {
   ...
   * 
   * @see edu.harvard.i2b2.explorer.KTableModel for more information.
   * @param model
   */
