 ...
 * 
 * 
 * @see edu.harvard.i2b2.explorer.ui.KTableModel
 * @see de.kupzog.ktable.KTableCellRenderer
 * @see edu.harvard.i2b2.explorer.ui.KTableCellEditor
 * @see edu.harvard.i2b2.explorer.ui.KTableCellSelectionListener
 * 
...
public class KTable extends Canvas {
   ...
   * 
   * @see edu.harvard.i2b2.explorer.ui.KTableModel for more information.
   * @param model
   */
