...
class LiteLabel implements Lite {
   ...
   */
  public static final Font DEFAULT_FONT = new Font("TimesRoman", Font.PLAIN, 11);
  ...
  public LiteLabel(String s, Point p, int border, Font f, Color fg, Color bg, int degree, record applet) {
    this(s, new Point(0,0), p, border, f, fg, bg, degree, applet);
  }
  
  public LiteLabel(String s, Point p, int border, Font f, Color fg, Color bg, int degree) {
  ...
  public LiteLabel(String s, Point sp, Point lp, int border, Font f, Color fg, Color bg)    {
  ...
  public void paint(Graphics g) {
    if (showlabel)  {
        if (degree == 0)    {
            ...
            */
            rotate = new Rotate(text, position, font, background, degree, applet);
            rotate.paint(g);
        }
    }
  }
   ...
   */
  public void setText(String s) { invalidate(); text = s; }
   ...
   * <code>LiteLabel.RIGHT</code>.
   */
  public void setAlignment(int a) { invalidate(); alignment = a; }
}
