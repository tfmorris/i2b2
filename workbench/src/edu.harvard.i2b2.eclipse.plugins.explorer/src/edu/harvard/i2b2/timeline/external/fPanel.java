...
public class fPanel extends Panel {
    ...
    /*
     * Constants to be used for font styles. Can be combined to mix
     * styles.
     */
    ...
    /*
     * Constants to be used for font styles. Cannot be combined to mix
     * styles.
     */

    /**
     * The Engraved style constant.  This cannot be combined with the other
     * style constants for mixed styles.
     */
    ...
    /**
     * The Embossed style constant.  This cannot be combined with the other
     * style constants for mixed styles.
     */
    ...
    /**
     * The Raised style constant.  This cannot be combined with the other
     * style constants for mixed styles.
     */
    ...
    /**
     * The Embeded style constant.  This cannot be combined with the other
     * style constants for mixed styles.
     */
    ...
    /**
     * The Plain style constant.  This cannot be combined with the other
     * style constants for mixed styles.
     */
    ...
    */
    ...
    /**
     * The style of the Border. This is the sum of the
     * constants ENGRAVED, EMBOSSED, RAISED, EMBEDED,or STANDARD.
     */
    ...
    */
    ...
    /**
    * Set the style of the border wished for the pannel
    * Set the size of the selected boreder
    */
    ...
    */
    ...
    public void setLabel(String label){
        ...
        if (this.label.length() <=1) {
            ...
            title.setFont(new Font(theFont.getName(), theFont.getStyle(), theFont.getSize()));
            this.add(title);
