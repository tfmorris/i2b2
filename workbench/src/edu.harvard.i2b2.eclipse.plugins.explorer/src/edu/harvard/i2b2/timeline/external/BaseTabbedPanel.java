...
/**
 * BaseTabbedPanelis a Panel extension which provides for
...
public abstract class BaseTabbedPanel extends Panel
{
    ...
    /**
     * Sets the panel to be shown by adding it to the base panel.
    ...
    /**
     * Sets and shows the panel to be shown by adding it to the base panel
     * if not already added and showing it. Hides all other (previous) panels,
	 ...
	 * The current active tab cannot be disabled.
