...
public class genRecord { 
    ...
    public void setXOverlap(conflictResolver xOverlap1, conflictResolver xOverlap2)
    {
        this.xOverlap1 = xOverlap1;
        this.xOverlap2 = xOverlap2;
    }
    ...
    public MyDate getStartdate(){
        return new MyDate(start_date.getMonth(),
        		start_date.getDay(),
        		start_date.getYear(),
        		start_date.getHour(),
        		start_date.getMin());
    ...
    public MyDate getEnddate(){
        return new MyDate(end_date.getMonth(),
        		end_date.getDay(),
        		end_date.getYear(),
        		end_date.getHour(),
        		end_date.getMin());
    ...
    public int storeRect(Rectangle rect,int rwinWidth,int rwinOffset,
                            MyDate validDateMin,MyDate validDateMax) { return 0; }
  ...
  public void draw(int currentY,timeLinePanel displayArea, boolean silhouette, boolean label, boolean timeline, boolean summaryrecord, boolean stream) { 
