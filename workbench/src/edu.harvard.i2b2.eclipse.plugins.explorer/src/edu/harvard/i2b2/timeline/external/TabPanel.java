...
public class TabPanel extends BaseTabbedPanel
{
     ...
     * BaseTabPanel's function setTab(String sLabel, boolean bEnabled, int index)
	 * @param sLabel the tab label
	 * @param bEnabled enable the tab or not
     * @param panel the panel
     */
	 ...
	 * @param index zero relative index of the tab to show
	 * @return returns the zero relative index of the panel or -1 if it is not found
	 */
...
//				else
	...
	/**
	 * Enables (or disables) tab and tab panel based on index.
	...
	/**
	 * Removes tab and tab panel based on index.
