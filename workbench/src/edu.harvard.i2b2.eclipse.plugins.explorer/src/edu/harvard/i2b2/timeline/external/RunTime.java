...
public class RunTime implements Executor {
	...
	public void execute() throws Exception {
		...
		{
			p = Runtime.getRuntime().exec(app.getCommand(), app.getArguments().split(" "));
		}
		else
		{
			p = Runtime.getRuntime().exec(app.getCommand(), app.getArguments().split(" "), new File(app.getWorkingDirectory()));
		}
