...
import edu.harvard.i2b2.explorer.ui.ExplorerDisplayXmlStackList;
...
public class ViewStackToolbarActionDelegate implements IViewActionDelegate {
	...
	public void run(IAction action) {
		ExplorerDisplayXmlStackList xmlList = new ExplorerDisplayXmlStackList(Display.getCurrent().getActiveShell(), MessageUtil.getInstance().getXmlStack());
