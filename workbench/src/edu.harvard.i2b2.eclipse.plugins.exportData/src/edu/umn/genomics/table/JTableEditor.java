/*
 * @(#) $RCSfile: JTableEditor.java,v $ $Revision: 1.3 $ $Date: 2008/10/31 17:43:22 $ $Name: RELEASE_1_3_1_0001b $
 *
...
public class JTableEditor extends AbstractTableSource {
    ...
    String[] columnTypes = { "Text", "Integer", "Number", "Date", "Boolean",
    // "Image",
    // "Color",
    };
    Class[] columnTypeClass = { java.lang.String.class,
	...
	try {
	    ...
	    // Graphics
	    newTblIcon = new ImageIcon(cl
		    .getResource("edu/umn/genomics/table/Icons/NewTable24.gif"));
	...
	newTblBtn = newTblIcon != null ? new JButton(newTblIcon) : new JButton(
		"New Table");
	...
	newTblBtn.addActionListener(new ActionListener() {
	...
	final JOptionPane optionPane = new JOptionPane(colPanel,
	...
	optionPane.addPropertyChangeListener(new PropertyChangeListener() {
		...
		if (dialog.isVisible() && (e.getSource() == optionPane)
			...
			if (name.length() > 0) {
			    newColumn(colIdx[0], name,
				    columnTypeClass[columnType
					    .getSelectedIndex()]);
