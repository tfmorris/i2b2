/**
 * @(#) $RCSfile: SpanPlot.java,v $ $Revision: 1.3 $ $Date: 2008/10/31 17:43:22 $ $Name: RELEASE_1_3_1_0001b $
 *
 ...
 * @see ColumnMap
 */
public class SpanPlot extends JPanel implements Serializable,
     ...
     * 
     * @param xColumn
     *            the column to map to the start of span on the x axis.
     * @param sColumn
     *            the column to map to the end of span on the x axis.
     * @param yColumn
     *            the column to map to the y axis.
    ...
    public void setColumnMaps(ColumnMap xColumn, ColumnMap sColumn,
	    ColumnMap yColumn) {
	if (xcol != null) {
	...
	if (newModel != null && newModel != lsm) {
		...
		// gp.setIndexedDrawable(new IndexSelectDrawable(new
		// DrawableX(), null, lsm));
	    }
	}
    }
