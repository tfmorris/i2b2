/*
 * @(#) $RCSfile: HistogramDisplay.java,v $ $Revision: 1.3 $ $Date: 2008/10/31 17:43:22 $ $Name: RELEASE_1_3_1_0001b $
 *
...
public class HistogramDisplay extends JPanel {
	...
	public String getLabel(double value) {
		...
		int idx = (int) value;
		try {
		    int[] indices = MultiDimIntArray.getIndices(idx, hgm
			    .getDimensions());
    ...
    public synchronized int[][] getPointArray(int x, int y, Axis axes[],
	    boolean selectCnt) {
