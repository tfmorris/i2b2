...
public class DisplayXmlMessageDialog extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jFileMenu.setText(Messages.getString("DisplayXmlMessageDialog.File")); //$NON-NLS-1$
        jCloseMenuItem.setText(Messages.getString("DisplayXmlMessageDialog.Close")); //$NON-NLS-1$
