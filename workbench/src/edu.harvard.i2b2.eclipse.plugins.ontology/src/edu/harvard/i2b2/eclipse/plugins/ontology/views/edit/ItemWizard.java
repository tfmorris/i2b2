...
public class ItemWizard extends Wizard {
	private static final Log log = LogFactory.getLog(ItemWizard.class);
	...
	public ItemWizard() {
		...
		setWindowTitle(Messages.getString("ItemWizard.WindowTitle")); //$NON-NLS-1$
	...
	public IWizardPage getNextPage(IWizardPage page) {
		...
		if (page instanceof ItemSettingsPage) {
			((ItemSettingsPage) page).updateMetadataRecord();
			okToFinish = false;
		}
...
class ItemSettingsPage extends WizardPage {
	...
	public static final String PAGE_NAME = "ItemSettings"; //$NON-NLS-1$
	
	public ItemSettingsPage() {
		super(PAGE_NAME); 
		setTitle(Messages.getString("ItemWizard.ItemSettings"));// + "\n\n" + notice);
