 ...
 * @author  wp066
 */
public class OntologyDisplayXmlMessageDialog extends javax.swing.JFrame {
	
    /** Creates new form OntologyDisplayXmlMessageDialog */
    public OntologyDisplayXmlMessageDialog(String msg) {
    ...
    private void initComponents() {
        ...
        java.awt.Image img = this.getToolkit().getImage(OntologyDisplayOptionsDialog.class.getResource("core-cell.gif"));
