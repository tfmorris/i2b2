...
public class TopPanel extends javax.swing.JPanel {
    private static final Log log = LogFactory.getLog(TopPanel.class);
	...
	jOptionsPanel.setBounds(width - 112, 28, 108, height - 58);
	// jOptionsScrollPane.setViewportView(jOptionsPanel);
	...
	jNameLabel.setBounds(6, 6, width - 146, 23);
	// jQueryNamePanel.setBounds(5, 4, width-121, 26);
	jClearGroupsButton.setBounds(width - 136, 6, 18, 23);
	jAnalysisLabel.setBounds(width - 112, 6, 108, 23);
	...
	for (int i = 0; i < c; i++) {
	    ConceptTreePanel panel = dataModel.getTreePanel(i);
	...
	protected Transferable createTransferable(JComponent c) {
		...
		if (jPanel1.getComponent(i) instanceof ConceptTreePanel) {
		    ConceptTreePanel panel = (ConceptTreePanel) jPanel1
