...
import edu.harvard.i2b2.eclipse.plugins.ontology.ws.GetTermInfoResponseMessage;
...
//			parentType.setType("all");
	...
	//		log.info("making web service call " + time);
			...
			//System.out.println("Ontology service getTermInfo response: "+response);
	...
	/* old implementation using select service
	public void setXmlContent() {
		org.w3c.dom.Document doc = QuerySelectServiceClient.getXMLResult(this, 1);
