...
public class QueryDisplayOptionsDialog extends javax.swing.JFrame {
     ...
     */
    public QueryDisplayOptionsDialog(QueryView queryView) {
    ...
    private void initComponents() {
        ...
        jOKButton.setBounds(50, 80, 50, 23);
        ...
        jCancelButton.setBounds(190, 80, 70, 23);
        ...
        jNumberOfQueryTextField.setBounds(270, 10, 60, 20);
        ...
        jLabel2.setBounds(18, 40, 250, 20);

        jMaxWaitingTimeTextField.setText("180");
        getContentPane().add(jMaxWaitingTimeTextField);
        jMaxWaitingTimeTextField.setBounds(270, 40, 60, 20);
        jMaxWaitingTimeTextField.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
    ...
    private void jOKButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	queryView_.queryPanel().getTopPanel().max_child(new Integer(num).intValue());
    	System.setProperty("QueryToolMaxWaitingTime", seconds);
    	setVisible(false);
    }
    
    private void jMaxWaitingTimeTextFieldActionPerformed(java.awt.event.ActionEvent evt) {
