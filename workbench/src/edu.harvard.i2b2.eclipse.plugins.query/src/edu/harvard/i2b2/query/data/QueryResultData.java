...
public class QueryResultData extends QueryData {
	...
	public String writeXMLDocumentQueryXML() {		
		...
		headerType.setRequestType(PsmRequestTypeType.CRC_QRY_GET_RESULT_DOCUMENT_FROM_RESULT_INSTANCE_ID);
		...
		//System.out.println("Generated XML document request: " + strWriter.toString());
