...
public class SoapClient {
	...
	public static String getQueryString() throws Exception  { 
		...
		DataInputStream dataStream = new DataInputStream(new FileInputStream("c:\\test\\pdo_request_of_a_single_patient.xml"));
	...
	public static SOAPEnvelope creatSOAPEnvelope(String xmlStr) {
		...
		try {
			...
			OMElement method = fac.createOMElement("GetSinglePatientData", omNs);
			OMElement value = fac.createOMElement("PatientDataRequestXml", omNs);
