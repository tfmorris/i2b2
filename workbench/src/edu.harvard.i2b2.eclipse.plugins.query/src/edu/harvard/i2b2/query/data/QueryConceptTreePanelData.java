...
public class QueryConceptTreePanelData implements QueryConstrains {
    ...
    public void exclude(boolean b) {exclude = b;}
    public boolean exclude() {return exclude;}
	...
	public void setOccurrenceTimes(int i) {occurrenceTimes=i;}
	public int getOccurrenceTimes() {return occurrenceTimes;}
	...
	public ConstrainByDate writeTimeConstrain(ConstrainDateType from, ConstrainDateType to) {
		...
		if(from != null) {
			...
			startTime = cal.getTimeInMillis(); //  new Date(startYear, startMonth, startDay).getTime();
		...
		if(to != null) {
			...
			endTime = cal.getTimeInMillis(); //  new Date(startYear, startMonth, startDay).getTime();
