/*
 * $Id: JDatePicker.java,v 1.2 2008/02/19 19:39:41 mem61 Exp $
 *
 ...
 * Class: JDatePicker 
 * 
 * Based on JXDatePicker from JDNC. Several modifications have been made for it being used in 
 * QueryConstrainFrame class. (wp066)
 * 
 */
    ...
    private class Handler implements MouseListener, MouseMotionListener {
        ...
        public void toggleShowPopup() {
            ...
            if (!_popup.isVisible()) {
                ...
                _popup.show(JDatePicker.this,
                        0, JDatePicker.this.getHeight());
            } else {
