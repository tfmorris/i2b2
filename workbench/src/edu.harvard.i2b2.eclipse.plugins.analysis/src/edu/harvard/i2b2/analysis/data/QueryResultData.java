...
public class QueryResultData extends QueryData {
	...
	/*
	 * int count = Integer.parseInt(patientCount); try {
	 ...
	 * Integer(0), new Integer(5), false); requestXml = pdoFactory.
	 * requestXmlMessage(patientRefId, new Integer(1), new Integer(count),
	 * false); } catch(Exception e) { e.printStackTrace(); return "error"; }
	 */
	return requestXml;
    }
