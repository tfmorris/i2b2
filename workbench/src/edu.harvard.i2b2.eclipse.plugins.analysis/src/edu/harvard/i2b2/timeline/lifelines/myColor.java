...
public class myColor {
    ...
    public Color getColor2() {
        ...
        if(colorString.compareTo("severe") == 0 || colorString.compareTo("red") == 0)
   ...
   public String getColorString(Color color)    {
		...
		else if(color.getRed() == 51 && color.getGreen() == 25 && color.getBlue() == 240) 
		    cString = new String("blue");
		else if(color.getRed() == 101 && color.getGreen() == 153 && color.getBlue() == 240)
		    cString = new String("mediumblue");
		else if(color.getRed() == 142 && color.getGreen() == 205 && color.getBlue() == 240)
		    cString = new String("lightblue");
        else if(color.getRed() == 255 && color.getGreen() == 245 && color.getBlue() == 200)
            cString = new String("lightbrown");
        else if(color.getRed() == 255 && color.getGreen() == 236 && color.getBlue() == 175)
