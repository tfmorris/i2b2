...
public class labelPanel extends Panel {
  ...
  //  private int SIZE = 300;
	...
	//private Scrollbar bar = new Scrollbar(Scrollbar.VERTICAL, 10, 64, 10, SIZE);
    ...
    public labelPanel(int width, int height) {
       ...
       // this.add(bar);
        ...
        //System.out.println("columns: " + Integer.toString(labelText.getColumns()));
	...
	/*  int currH = 20;
        ...
        //g.drawString("Diabetic retinopathy", 10, currH + fontMetrics.getHeight());
        g.drawString(label, 10, currH + fontMetrics.getHeight());
	...
	if(words.hasMoreTokens()) {
         ...
         while( words.hasMoreTokens() ) {
            ...
            actually formats the data on the top right hand panel so that some sense
            can be made out of the data */
            
            
            /*if ((word.charAt(1) == '-' || word.charAt(2) == '-') && (word.charAt(3) == '-' ||word.charAt(4) == '-' || word.charAt(5) == '-')){
               
                if (countDate == 0){
                   word = new String(" DATE : "+word);
                   countDate++;
                }else if (countDate == 1){
            ...
            if ((word.compareTo("black") == 0) || (word.compareTo("blue") == 0) || (word.compareTo("lightgray") == 0) || (word.compareTo("lightbrown") == 0) || (word.compareTo("darkbrown") == 0) || (word.compareTo("green") == 0) || (word.compareTo("severe") == 0)|| (word.compareTo("lightblue") == 0) || (word.compareTo("red") == 0) )
            {
            ...
            {
                word = new String("LABEL : "+word);
            }*/
               
           /* if( (word.charAt(0) == 'p') && (Character.isDigit(word.charAt(1))) )
            {
                word = new String("THICKNESS (in pixels) : "+word);*/
            //}
	      ...
	      //labelText.appendText("\n");    
            ...
            g.drawString(word + "  ",currentWidth - fm.stringWidth(word + "  "),height);       
