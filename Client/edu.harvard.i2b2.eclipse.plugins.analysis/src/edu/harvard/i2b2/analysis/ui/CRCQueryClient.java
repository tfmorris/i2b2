...
import edu.harvard.i2b2.analysis.dataModel.PDOItem;
import edu.harvard.i2b2.analysis.dataModel.PDORequestMessageModel;
import edu.harvard.i2b2.analysis.dataModel.PDOResponseMessageModel;
import edu.harvard.i2b2.analysis.dataModel.TimelineFactory;
...
public class CRCQueryClient {
    private static final Log log = LogFactory.getLog(CRCQueryClient.class);
