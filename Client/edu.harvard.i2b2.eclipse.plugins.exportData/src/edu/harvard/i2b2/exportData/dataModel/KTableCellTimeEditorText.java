...
import edu.harvard.i2b2.exportData.ui.TimeConstrainFrame;

public class KTableCellTimeEditorText extends KTableCellEditor {
    private Text m_Text;
	...
	QueryConceptData ndata = (QueryConceptData) ((ConceptKTableModel) m_Model)
		.getContentAt(5, row);
	// ((ConceptKTableModel)m_Model).valueMode(m_Row);

	TimeConstrainFrame vDialog = new TimeConstrainFrame(ndata, m_Table);
