/*
 * @(#) $RCSfile: ClutoSolution.java,v $ $Revision: 1.3 $ $Date: 2008/11/21 17:18:38 $ $Name: RELEASE_1_3_1_0001b $
 *
...
/**
 * ClutoSolution provides access to the result from executing a <b>CLUTO</b>
 * clustering method.
 * 
 * @author J Johnson
 * @version $Revision: 1.3 $ $Date: 2008/11/21 17:18:38 $ $Name: RELEASE_1_3_1_0001b $
 */
public interface ClutoSolution {
    /**
    ...
    // Possible Tree Node methods that could be added
    // public int getParentNode(int nodeIndex);
    // public int[] getChildNode(int nodeIndex);
