/*
 * Copyright (c) 2006-2014 Partners Healthcare 
...
{	
	private ScheduledExecutorService 	myTermFetchScheduler 	= Executors.newScheduledThreadPool( 3, new DefaultDaemonThreadFactory("TermFetchDaemonRunner") );	// display cfind indicator so users don't think it's stuck
