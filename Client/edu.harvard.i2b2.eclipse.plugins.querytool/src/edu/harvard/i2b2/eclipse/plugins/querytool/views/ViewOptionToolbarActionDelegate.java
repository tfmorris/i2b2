...
{
	private QueryToolView queryview;
	...
	public void run(IAction action) 
	{
		...
		ViewOptionsDialog dialog = new ViewOptionsDialog(queryview.getMainUI().getShell());
		dialog.open();
	}
