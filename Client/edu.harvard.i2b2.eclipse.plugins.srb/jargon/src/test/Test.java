...
System.out.println("\n Connect to the remote server.");
      ...
      //test all remote filesystems
      GeneralAccount[] accounts = {
        //irods
        new IRODSAccount( ),
        //srb
        new SRBAccount( ),
        //http (read-only)
        FileFactory.newFileSystem( new URI("http://www.yahoo.com") ).getAccount(),
      };
  ...
  System.out.println(
    "\n Make a new collection in your remote server home called "+
    TEST_DIR);
        /**
...
*/          }
  ...
  System.out.println(
    ...
    " put it in the current local directory as "+
    LOCAL_TEST_FILE);
        /**
