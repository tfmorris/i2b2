...
public  class VerifyDataPatientMapping implements VerifyData {
	...
	public void init()
	{
		...
		headerName.add("PIDE"); headerName.add("PISE"); headerName.add("PNUM"); 
		headerName.add("PISS"); headerName.add("UPDA"); headerName.add("DOWN"); 
	...
	public void setHeaderLocation(String name, int count)
	{
		...
		if (name.startsWith("PATIENTIDSOURCE"))
			name = "PISE";		
		else if (name.startsWith("PATIENTIDSTATUS"))
			name = "PISS";		
		else if (name.startsWith("PATIENTID"))
			name = "PIDE";		
		else if (name.startsWith("PATIENTNUM"))
			name = "PNUM";		
	...
	public void validateData(TableItem abc, boolean editable, boolean hasStatus, Vector<String> csv, String[] headers)
	{
		...
		if (hasStatus) {
			...
			//PK can not be null
			loc = headerLocation[headerName.indexOf("PIDE") ];
			isNotNull(abc,loc,csv.elementAt(loc));

			loc = headerLocation[headerName.indexOf("PISE") ];
			isNotNull(abc,loc,csv.elementAt(loc));
