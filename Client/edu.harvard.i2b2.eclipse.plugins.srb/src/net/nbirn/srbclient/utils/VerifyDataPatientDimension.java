...
public  class VerifyDataPatientDimension implements VerifyData {
	...
	public void init()
	{
		...
		headerName.add("PATI"); headerName.add("VITA"); headerName.add("BIRT"); headerName.add("DEAT");
		headerName.add("SEXC"); headerName.add("AGEI"); headerName.add("LANG"); headerName.add("RACE"); 
		headerName.add("MARI"); headerName.add("RELI"); headerName.add("ZIPC"); headerName.add("STAT"); 
	...
	public void validateData(TableItem abc, boolean editable,  boolean hasStatus, Vector<String> csv, String[] headers)
	{
		...
		if (hasStatus){
			...
			//Verify Number is a number
			loc = headerLocation[headerName.indexOf("AGEI") ];
			if (csv.size() > loc)
				isNumber(abc,loc,csv.elementAt(loc));
			...
			//Verify Date
			loc = headerLocation[headerName.indexOf("BIRT") ];
			if (csv.size() > loc)
				isDate(abc,loc,csv.elementAt(loc));
			loc = headerLocation[headerName.indexOf("DEAT") ];
			if (csv.size() > loc)
				isDate(abc,loc,csv.elementAt(loc));
