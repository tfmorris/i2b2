 ...
 * @author  wp066
 */
public class FRDisplayXmlMessageDialog extends javax.swing.JFrame {
	
    /** Creates new form OntologyDisplayXmlMessageDialog */
    public FRDisplayXmlMessageDialog(String msg) {
    ...
    private void initComponents() {
        ...
        java.awt.Image img = this.getToolkit().getImage(FRDisplayOptionsDialog.class.getResource("non-core-cell.gif")); //$NON-NLS-1$
        ...
        jFileMenu.setText(Messages.getString("FRDisplayXmlMessageDialog.File")); //$NON-NLS-1$
        jCloseMenuItem.setText(Messages.getString("FRDisplayXmlMessageDialog.Close")); //$NON-NLS-1$
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FRDisplayXmlMessageDialog(null).setVisible(true);
            }
        });
    }
