 ...
 * @author  wp066
 */
public class WorkplaceDisplayXmlMessageDialog extends javax.swing.JFrame {
	
    /** Creates new form OntologyDisplayXmlMessageDialog */
    public WorkplaceDisplayXmlMessageDialog(String msg) {
    ...
    public WorkplaceDisplayXmlMessageDialog(List<String> msgs) {
    ...
    private void initComponents() {
        ...
        java.awt.Image img = this.getToolkit().getImage(WorkplaceDisplayOptionsDialog.class.getResource("non-core-cell.gif"));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	String empty = null;
                new WorkplaceDisplayXmlMessageDialog(empty).setVisible(true);
            }
        });
    }
