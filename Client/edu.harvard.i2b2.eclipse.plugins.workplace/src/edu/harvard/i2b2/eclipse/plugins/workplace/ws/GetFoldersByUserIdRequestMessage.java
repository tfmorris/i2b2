 ...
 *
 */
public class GetFoldersByUserIdRequestMessage extends WorkplaceRequestData {
	
	public static final String THIS_CLASS_NAME = GetFoldersByUserIdRequestMessage.class.getName();
    private Log log = LogFactory.getLog(THIS_CLASS_NAME);	

    private GetReturnType returnType;


	public GetFoldersByUserIdRequestMessage() {}
	...
	public BodyType getBodyType() {
		...
		bodyType.getAny().add(of.createGetFoldersByUserId(returnType));
		return bodyType;
	}
