 ...
 *
 */
public class RenameChildRequestMessage extends WorkplaceRequestData {
	
	public static final String THIS_CLASS_NAME = RenameChildRequestMessage.class.getName();
    private Log log = LogFactory.getLog(THIS_CLASS_NAME);	

    private RenameChildType renameChildType;

	public RenameChildRequestMessage() {}
	 ...
	 */
	public RenameChildType renameChildType() { 
	...
	public BodyType getBodyType() {
		...
		bodyType.getAny().add(of.createRenameChild(childType));
		return bodyType;
	}
	...
	public BodyType getBodyType(RenameChildType childType) {
		edu.harvard.i2b2.wkplclient.datavo.wdo.ObjectFactory of = new edu.harvard.i2b2.wkplclient.datavo.wdo.ObjectFactory();
	 ...
	 */
	public String doBuildXML(RenameChildType nodeData){ 
