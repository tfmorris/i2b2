...
public class QueryInstanceData extends QueryData {
	...
	public String writeContentQueryXML() {
		...
		headerType.setRequestType(PsmRequestTypeType.CRC_QRY_GET_QUERY_RESULT_INSTANCE_LIST_FROM_QUERY_INSTANCE_ID);
		
		instanceRequestType.setQueryInstanceId(Integer.parseInt(id()));
