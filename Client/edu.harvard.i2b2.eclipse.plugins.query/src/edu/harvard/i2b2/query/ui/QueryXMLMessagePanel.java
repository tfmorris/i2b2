 ...
 * @author  wp066
 */
public class QueryXMLMessagePanel extends javax.swing.JPanel {
    
    /** Creates new form QueryXMLMessagePanel */
    public QueryXMLMessagePanel() {
        initComponents();
    }
    ...
    private void formComponentResized(java.awt.event.ComponentEvent evt) {
    	...
    	jScrollPane2.setBounds(30, height+30, getWidth()-60, getHeight()-height-50);
    }
