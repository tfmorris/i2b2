...
public class QueryDisplayXmlMessageDialog extends javax.swing.JFrame {
	
    /** Creates new form QueryDisplayXmlMessageDialog */
    public QueryDisplayXmlMessageDialog(String msg) {
   	
        initComponents();
        setSize(800, 400);
        jMessageTextArea.setText(msg);
    }
    public QueryDisplayXmlMessageDialog(List<String> msgs) {
    ...
    private void initComponents() {
        ...
        java.awt.Image img = this.getToolkit().getImage(QueryDisplayXmlMessageDialog.class.getResource("core-cell.gif"));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
            	String empty = null;
                new QueryDisplayXmlMessageDialog(empty).setVisible(true);
            }
        });
    }
