...
import edu.harvard.i2b2.eclipse.plugins.query.utils.StackData;
import edu.harvard.i2b2.query.serviceClient.QueryStatPanel;

public class QueryToolPanel extends javax.swing.JPanel {

	private static final int MAX_STACK_SIZE = 28;
	private MainPanelModel dataModel;

	public MainPanelModel dataModel() {
		return dataModel;
	}
	...
	// public void lastRequestMessage(String str) {lastRequestMessage = str;}
	...
	// public void lastResponseMessage(String str) {lastResponseMessage = str;}
	 ...
	 * 
	 * public List<StackData> getXmlStack() {return xmlStack;}
	 * 
	 * public void lastRequestMessage(String msg) { lastRequestMessage = msg;
	 * if(xmlStack == null) xmlStack = new ArrayList<StackData>(); StackData
	 * stackData = new StackData(); stackData.setMessage(msg);
	 * stackData.setName("Sent" + stackData.getTimestamp()); xmlStack.add(
	 * stackData ); }
	 * 
	 * 
	 * public void lastResponseMessage(String msg) { lastResponseMessage = msg;
	 * if(xmlStack == null) xmlStack = new ArrayList<StackData>(); StackData
	 * stackData = new StackData(); stackData.setMessage(msg);
	 * stackData.setName("Received" + stackData.getTimestamp()); xmlStack.add(
	 * stackData ); }
	 * 
	 * private void checkXmlStackSize(){ if(xmlStack.size() == MAX_STACK_SIZE) {
	 * xmlStack.remove(0); xmlStack = xmlStack.subList(1,MAX_STACK_SIZE-1); } }
	 */
	/** Creates new form QueryToolPanel */
	public QueryToolPanel(QueryC parentC) {
		dataModel = new MainPanelModel();
		parent = parentC;
		initComponents();
		dataModel.setTopPanel(mainPanel);
	}
