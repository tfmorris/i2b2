...
public class UnitsData {
	...
	public void needConvertion(boolean b) {
		needConvertion = b;
	}

	public boolean needConvertion() {
	 ...
	 * @param mFactor
	 */
	public UnitsData(String name, double mFactor, boolean convertion) {
		super();
		this.name = name;
		this.mFactor = mFactor;
		this.needConvertion = convertion;
	}
