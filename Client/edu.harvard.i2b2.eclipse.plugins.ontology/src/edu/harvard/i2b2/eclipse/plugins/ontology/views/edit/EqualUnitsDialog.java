 ...
 * @author  lcp5
 */
public class EqualUnitsDialog extends Dialog {
    
	private Text nameBox;
    /**
     * Creates Keyword Dialog
     */
    public EqualUnitsDialog(Shell parentShell) {
    	super(parentShell);
	...
	protected Control createDialogArea(Composite parent){
    	...
    	comp.getShell().setText("Enter equivalent unit of measurement");
    	
       	GridLayout layout = (GridLayout)comp.getLayout();
    	layout.numColumns = 2;
    	
    	Label synLabel = new Label(comp, SWT.RIGHT);
    	synLabel.setText("Equivalent Unit text: ");
	...
	protected void buttonPressed(int buttonId){
    	...
    	// OK
    	if(buttonId == 0){
    		ValueMetadata.getInstance().setEqualUnit(nameBox.getText());
