...
public class ModifierContainerWizard extends Wizard {
	private static final Log log = LogFactory.getLog(ModifierContainerWizard.class);
	private boolean okToFinish = false;

	public ModifierContainerWizard() {
		setWindowTitle(Messages.getString("ModifierContainerWizard.WindowTitle")); //$NON-NLS-1$
	...
	public void addPages() {
		addPage(new ModifierContainerSettingsPage());
...
//		addPage(new ValueMetadataSettingsPageOne());
	...
	public IWizardPage getNextPage(IWizardPage page) {
		if (page instanceof ModifierContainerSettingsPage) {
			((ModifierContainerSettingsPage) page).updateMetadataRecord();
			okToFinish = false;
		}
...
class ModifierContainerSettingsPage extends WizardPage {
	...
	public static final String PAGE_NAME = "ModifierContainerSettings"; //$NON-NLS-1$
	
	public ModifierContainerSettingsPage() {
		super(PAGE_NAME); 
		
//		String notice = "Selected Parent is: " + MetadataRecord.getInstance().getMetadata().getKey();			
		setTitle(Messages.getString("ModifierContainerWizard.ItemSettings"));// + "\n\n" + notice);
...
*/		
	...
	//	new Label(parentInfo, SWT.NONE).setImage(image);
		...
		new Label (itemSettings, SWT.NONE).setText("*Modifier Container Name:");			
		text1 = new Text(itemSettings, SWT.BORDER);
		text1.setToolTipText("The Modifier Container Name is the name that appears in the navigate tree.");
