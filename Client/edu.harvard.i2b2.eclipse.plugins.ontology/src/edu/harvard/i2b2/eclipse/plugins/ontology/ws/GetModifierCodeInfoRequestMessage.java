...
public class GetModifierCodeInfoRequestMessage extends OntologyRequestData {
	public static final String THIS_CLASS_NAME = GetModifierCodeInfoRequestMessage.class.getName();
    private Log log = LogFactory.getLog(THIS_CLASS_NAME);	

    public GetModifierCodeInfoRequestMessage() {}
	...
	public BodyType getBodyType() {
		...
		bodyType.getAny().add(of.createGetModifierCodeInfo(vocabType));
		return bodyType;
	}
