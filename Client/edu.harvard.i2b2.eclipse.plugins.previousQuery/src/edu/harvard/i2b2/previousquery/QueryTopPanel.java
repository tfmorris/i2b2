...
public class QueryTopPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        add(jRemoveAllButton);
        jRemoveAllButton.setBounds(115, 10, 90, 23);
   ...
   /* private void jDeleteButtonActionPerformed(java.awt.event.ActionEvent evt) {
				...
				if(response != null) {
			        ...
			        try {
				    	...
				    	if(status.equalsIgnoreCase("DONE")) {
				        	...
				        	String refId = new Integer(queryResultInstanceType.getResultInstanceId()).toString();
						    ...
						    //	parentPanel.getParentC().bottomC().setPatientSetText("Patient Set: "+count+" Patients");
						    //	parentPanel.getParentC().bottomC().setPatientMinNumText("0");
						    //	parentPanel.getParentC().bottomC().patientRefId(refId); 
					    	//}
					    	...
					    	//if(parentPanel.getParentC().bottomC() != null) {
					    	//	parentPanel.getParentC().bottomC().populateTable(nodeXmls);
					    	//	parentPanel.getParentC().bottomC().generateTimeLine();
					    	//}
				    	}
				    	else {
				    		JOptionPane.showMessageDialog(parentPanel, "Query is still running, you may check the result later using the previous query panel.");
    ...
    public void reset() {
    	...
    	jPanel1.setPreferredSize(new Dimension(630, 150));
    	jScrollPane4.setViewportView(jPanel1);
    }
    ...
    private void jMorePanelsButtonActionPerformed(java.awt.event.ActionEvent evt) {
    	...
    	jPanel1.setPreferredSize(new Dimension(rightmostPosition+30+191, 150));
    	jScrollPane4.setViewportView(jPanel1);
