...
public class QueryPreviousRunsPanel extends javax.swing.JPanel implements
ActionListener, TreeExpansionListener, TreeWillExpandListener {

	private static final Log log = LogFactory
	.getLog(QueryPreviousRunsPanel.class);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getActionCommand().equalsIgnoreCase("Rename ...")) {
			...
			Object inputValue = JOptionPane.showInputDialog(this,
					...
					.substring(0, ndata.name().lastIndexOf("[") - 1));
				...
				java.awt.EventQueue.invokeLater(new Runnable() {
					public void run() {
						JOptionPane.showMessageDialog(parent,
								"There are no patients in this set.", "Message",
								JOptionPane.INFORMATION_MESSAGE);
					}
				});
