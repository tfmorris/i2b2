...
/**
 * The <code>Idle</code> class triggers a method when the user is idle for a
 * second.
 * 
 ...
 * @since JDK1.1.5
 */
public abstract class Idle implements MouseMotionListener, MouseListener,
		Runnable {
	...
	/**
	 * MouseListener method. We start worrying about idle time when we enter the
	 * managed Component.
	 */
	...
	/**
	 * MouseListener method. We stop worrying about idle time when we leave the
	 * managed Component.
	 */
	...
	/**
	 * The Component to manage should be registered for the <code>Idle</code> to
	 * react.
	 * <p>
	 * 
	 * @param c
	...
	/**
	 * The idle method is called when no mouse move happened in the last second
	 * on the managed component. By default, this method does nothing.
	 * <p>
	 * 
	 * @param x
