...
public class InfoPanel extends Panel {
	...
	public InfoPanel(int width, int height, String name, String gender,
			int age, String moreinfo) { // 3/28/98
	...
	public void paint(Graphics g) {
		...
		/*
		 * g.setColor(Color.black); addr = new String("1234 Pirate Street");
		 * g.drawString(addr, currX1, currH + fontMetrics.getHeight());
		 * 
		 * city = new String("Barbary Coast"); g.drawString(city, currX1, currH
		 * + 2*fontMetrics.getHeight());
		 * 
		 * phone = new String("(301)-234-6543"); g.drawString("Phone: " + phone,
		 * currX1, currH + 3*fontMetrics.getHeight());
		 * 
		 * dob = new String("9/12/35"); g.drawString("DOB: " + dob,
		 * currX2,currH);
		 * 
		 * race = new String("Caucasian"); g.drawString(race, currX2, currH +
		...
		g.drawString(Integer.toString(age), currX1 + 70, currH
				+ /* 2 */fontMetrics.getHeight());
