...
public class TimelineFactory {
	...
	public static String GetTimelineHeader() {
		...
		String date = cldr.get(Calendar.MONTH)+1 + "-" 
					+ cldr.get(Calendar.DAY_OF_MONTH) + "-"
					+ cldr.get(Calendar.YEAR);

		// replacing fixed today string with computed one
		//return "%beforeSeptember1997" + newline + "%today,5-31-2007 12:00"
		
		return "%beforeSeptember1997" + newline + "%today," + date + " 12:00"
				+ newline + newline +
				...
				"%person,i2b2 Timeline Application,.,2007,.,images/cath.gif"
				+ newline + newline +
